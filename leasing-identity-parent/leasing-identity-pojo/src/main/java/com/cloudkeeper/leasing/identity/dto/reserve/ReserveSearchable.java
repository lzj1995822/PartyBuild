package com.cloudkeeper.leasing.identity.dto.reserve;
 ...
 * @author asher
 */
@ApiModel(value = "后备人才 查询DTO", description = "后备人才 查询DTO")
@Getter
@Setter
@Accessors(chain = true)
@NoArgsConstructor
@AllArgsConstructor
public class ReserveSearchable extends BaseSearchable {
