package com.cloudkeeper.leasing.identity.dto.pardifficulty;
 ...
 * @author cqh
 */
@ApiModel(value = "困难党员 查询DTO", description = "困难党员 查询DTO")
@Getter
@Setter
@Accessors(chain = true)
@NoArgsConstructor
@AllArgsConstructor
public class ParDifficultySearchable extends BaseSearchable {
