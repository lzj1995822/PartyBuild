...
public class GenerateTemplateCodeUtil {
    ...
    /** 表名*/
    static String TABLE_NAME = "PAR_Activity";

    /** 创建liquibase xml 的id*/
    static final String CHANGE_SET_ID = "20190505-01";

    /** 类名*/
    static final String CLASS_NAME = "ParActivity";

    /** 类注释*/
    static final String CLASS_EXPLAIN = "活动";
